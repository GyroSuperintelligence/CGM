...
While these ratios show interesting patterns, the holonomy test yields 0.572 rad versus the theoretical 0.863 rad, indicating incomplete agreement with theoretical predictions.
