...
def test_monomial_audit():
    ...
    L_match = np.allclose(
        ...
        [L_expected_computed["hbar"], L_expected_computed["c"], L_expected_computed["m_anchor"]],
        rtol=1e-12
    )
    ...
    T_match = np.allclose(
        ...
        [T_expected_computed["hbar"], T_expected_computed["c"], T_expected_computed["m_anchor"]],
        rtol=1e-12
    )
...
def test_compton_scales():
    ...
    lambda_match = np.isclose(lambda_compton_computed, lambda_compton_expected, rtol=1e-12)
